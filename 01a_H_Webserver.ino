...
String responseHTML = ""
                      "<!DOCTYPE html><html><head><title>ESP-Tool</title></head><body>"
                      "<h1>Hello</h1><p>to start the controlpage please klick on link: "
                      " <a href='http://192.168.4.1'>Start Tool</a> </p></body></html>";
...
String getContent()
{
  ...
  if (datalog)
  {
    content += "<td align 'left'> Datalog (active): </td> <td align='center'> <a href='datalog'><button>-> stop datalogging </button></a></td>";
  }
  else
  {
    content += "<td align 'left'> Datalog (inactive): </td> <td align='center'> <a href='datalog'><button>-> start datalogging </button></a></td>";
  }
